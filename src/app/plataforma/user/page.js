    ...
    return (
      ...
      <div>
          <div class="bg-white relative shadow rounded-lg w-5/6 md:w-5/6  lg:w-4/6 xl:w-3/6 mx-auto">
              ...
              <div class="mt-16">
                  <h1 class="font-bold text-center text-3xl text-gray-900">Nome Eleitor</h1>
                  <p class="text-center text-sm text-gray-400 font-medium">Eleitor</p>
                  <p>
                      <span>
                  ...
                  <div class="my-5 px-6">
                      <a href="#" class="text-gray-200 block rounded-lg text-center font-medium leading-6 px-6 py-3 bg-gray-900">Connect with <span class="font-bold">Email@gmail.com</span></a>
                  </div>
                  ...
                  <div class="w-full">
                      <h3 class="font-medium text-gray-900 text-left px-6">Atividades recentes</h3>
                      <div class="mt-5 w-full flex flex-col items-center overflow-hidden text-sm">
                          <a href="#" class="w-full border-t border-gray-100 text-gray-600 py-4 pl-6 pr-3 w-full block hover:bg-gray-100 transition duration-150">
                              <img src="https://avatars0.githubusercontent.com/u/35900628?v=4" alt="" class="rounded-full h-6 shadow-md inline-block mr-2" />
                                  Votou
                                  <span class="text-gray-500 text-xs"> 24 minutos atrás</span>
                          </a>

                          <a href="#" class="w-full border-t border-gray-100 text-gray-600 py-4 pl-6 pr-3 w-full block hover:bg-gray-100 transition duration-150">
                              <img src="https://avatars0.githubusercontent.com/u/35900628?v=4" alt="" class="rounded-full h-6 shadow-md inline-block mr-2" />
                                  Criou uma nova chapa
                                  <span class="text-gray-500 text-xs"> 42 minutos atrás</span>
                          </a>

                          <a href="#" class="w-full border-t border-gray-100 text-gray-600 py-4 pl-6 pr-3 w-full block hover:bg-gray-100 transition duration-150">
                              <img src="https://avatars0.githubusercontent.com/u/35900628?v=4" alt="" class="rounded-full h-6 shadow-md inline-block mr-2"/>
                              Editou o perfil
                              <span class="text-gray-500 text-xs">1 dia atrás</span>
                          </a>
                      </div>
                  </div>
              </div>
